...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 selection:bg-[#006bff]/10 font-sans antialiased overflow-x-hidden">
      ...
      {/* Decorative top-right background gradients */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-[#006bff]/5 filter blur-3xl pointer-events-none" />
      <div className="absolute top-[20%] left-[-100px] w-[400px] h-[400px] rounded-full bg-purple-500/5 filter blur-3xl pointer-events-none" />

      {/* Sticky Premium Header */}
      <header className="sticky top-0 z-50 border-b border-gray-50 bg-white/85 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#006bff] text-white font-extrabold relative shadow-md shadow-[#006bff]/20 animate-pulse-glow">
          ...
          <div className="flex items-center gap-4">
            <Link href="/login" className="text-xs font-bold text-gray-500 hover:text-black transition-colors">
              Sign in
            </Link>
            <Link
              href="/signup"
              className="rounded-full bg-[#006bff] px-6 py-3 text-xs font-bold text-white hover:bg-[#0052cc] hover:scale-[1.03] active:scale-[0.98] transition-all shadow-md shadow-[#006bff]/10"
            >
              Get started
            </Link>
          </div>
      ...
      <main className="relative">
        ...
        {/* HERO SECTION */}
        <section className="mx-auto max-w-7xl px-6 pt-20 pb-28 md:py-36 grid gap-12 lg:grid-cols-12 items-center">
          
          {/* Hero text (Left column) */}
          <div className="lg:col-span-6 space-y-8 animate-slideInLeft">
            <h1 className="text-6xl md:text-7xl lg:text-[5.5rem] font-black text-gray-900 tracking-tight leading-[1.02]">
            ...
            <form onSubmit={handleEmailSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md">
              <input
                ...
                className="w-full rounded-full border border-gray-200 bg-[#f9fafc] px-6 py-4 text-sm focus:border-[#006bff] focus:outline-none focus:ring-1 focus:ring-[#006bff]/20 font-medium transition-all"
              />
              <button
                type="submit"
                className="rounded-full bg-[#006bff] px-8 py-4 text-sm font-bold text-white hover:bg-[#0052cc] hover:scale-[1.03] active:scale-[0.98] transition-all whitespace-nowrap shadow-lg shadow-[#006bff]/20 animate-pulse-glow"
              >
                Sign up for free
              </button>
            </form>
          ...
          <div className="lg:col-span-6 flex justify-center relative">
            ...
            <div className="w-full max-w-md rounded-3xl border border-gray-100 bg-white p-7 shadow-2xl relative z-10 animate-float-card">
        ...
        {/* TRUST BAR */}
        <section className="bg-gray-50/50 py-12 border-t border-b border-gray-100">
          <div className="mx-auto max-w-7xl px-6 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-12 opacity-40 font-bold text-base tracking-widest text-gray-500 uppercase">
              <span>Google</span>
              <span>Microsoft</span>
              <span>Slack</span>
              <span>Vercel</span>
        ...
        <section id="features" className="mx-auto max-w-7xl px-6 py-28 sm:py-36 space-y-20">
          <div className="text-center max-w-2xl mx-auto space-y-4 animate-slideUp">
            <h2 className="text-xs font-bold text-[#006bff] uppercase tracking-widest">How Callendly Works</h2>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              <div key={item.step} className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm hover:scale-[1.02] hover:shadow-lg transition-all duration-300 relative overflow-hidden group">
                <div className="absolute top-4 right-4 text-4xl font-black text-gray-100 group-hover:text-blue-50 transition-colors">
                  {item.step}
                </div>
                <div className={`mb-6 flex h-14 w-14 items-center justify-center rounded-2xl border ${item.color} shadow-inner`}>
                  <item.icon className="h-6 w-6" />
                </div>
                <h4 className="text-xl font-extrabold text-gray-900">{item.title}</h4>
                <p className="mt-4 text-xs text-gray-400 leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="integrations" className="bg-[#fafbfe] py-28 sm:py-36 border-t border-b border-gray-100">
          <div className="mx-auto max-w-7xl px-6 grid gap-12 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-7 grid grid-cols-3 sm:grid-cols-4 gap-4">
              {[
                ...
                <div key={app.name} className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm hover:scale-[1.05] transition-all text-center space-y-1 hover:shadow-md cursor-default">
                  <span className="h-9 w-9 bg-blue-50 text-[#006bff] rounded-xl font-black text-xs inline-flex items-center justify-center mb-2">
                    {app.name[0]}
                  </span>
        ...
        <section id="pricing" className="mx-auto max-w-7xl px-6 py-28 sm:py-36 space-y-20">
          <div className="text-center max-w-2xl mx-auto space-y-4 animate-slideUp">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {/* Free Plan */}
            <div className="rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:scale-[1.04] hover:shadow-xl transition-all duration-300 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div>
                  <h4 className="font-extrabold text-xs text-gray-400 uppercase tracking-widest">Free</h4>
              ...
              <Link href="/signup" className="w-full text-center py-3 rounded-full border border-gray-200 text-xs font-bold text-gray-700 hover:bg-gray-50 transition-colors">
                Sign up
              </Link>
            </div>

            {/* Standard Plan (Popular) */}
            <div className="rounded-3xl border-2 border-[#006bff] bg-white p-7 shadow-md hover:scale-[1.04] hover:shadow-2xl transition-all duration-300 flex flex-col justify-between space-y-6 relative overflow-hidden">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-extrabold text-xs text-gray-400 uppercase tracking-widest">Standard</h4>
                  <p className="text-3xl font-black text-gray-900 mt-2">$10</p>
              ...
              <Link href="/signup" className="w-full text-center py-3 rounded-full bg-[#006bff] text-xs font-bold text-white hover:bg-[#0052cc] transition-colors shadow-sm shadow-[#006bff]/20 animate-pulse-glow">
                Buy standard
              </Link>
            </div>
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:scale-[1.04] hover:shadow-xl transition-all duration-300 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div>
                  <h4 className="font-extrabold text-xs text-gray-400 uppercase tracking-widest">Teams</h4>
                  <p className="text-3xl font-black text-gray-900 mt-2">$16</p>
                  <p className="text-[10px] text-gray-400 font-semibold uppercase">Per user / month</p>
                </div>
                <div className="h-px bg-gray-100" />
                <ul className="space-y-2 text-xs text-gray-500 font-semibold">
              ...
              <Link href="/signup" className="w-full text-center py-3 rounded-full bg-gray-900 text-white text-xs font-bold hover:bg-gray-800 transition-colors">
                Get started
              </Link>
            </div>
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-7 shadow-sm hover:scale-[1.04] hover:shadow-xl transition-all duration-300 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div>
                  <h4 className="font-extrabold text-xs text-gray-400 uppercase tracking-widest">Enterprise</h4>
                  <p className="text-3xl font-black text-gray-900 mt-2">Custom</p>
              ...
              <a href="mailto:sales@callendly.app" className="w-full text-center py-3 rounded-full border border-gray-200 text-xs font-bold text-gray-700 hover:bg-gray-50 transition-colors">
                Contact sales
              </a>
            </div>
        ...
        <section className="bg-gray-900 text-white py-28 relative overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-6 grid gap-12 md:grid-cols-3 text-center relative z-10">
            <div className="space-y-2">
              <h3 className="text-6xl font-black text-[#006bff] tracking-tight">169%</h3>
              <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Return on Investment</p>
              <p className="text-xs text-gray-500">According to Forrester Forrester TEI Study</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-6xl font-black text-green-500 tracking-tight">160%</h3>
              <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">More Meetings Booked</p>
              <p className="text-xs text-gray-500">Coordinated schedules automatically</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-6xl font-black text-purple-500 tracking-tight">20%</h3>
              <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Sales Conversion Increase</p>
              <p className="text-xs text-gray-500">Faster response time to new leads</p>
            </div>
          </div>
        </section>

        {/* SECURITY & TRUST SEALS */}
        <section className="mx-auto max-w-7xl px-6 py-24 text-center space-y-10 border-b border-gray-100">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-[10px] font-bold text-gray-400 uppercase tracking-wider">
            <div className="flex items-center gap-2 bg-gray-50 px-5 py-2.5 rounded-xl border border-gray-100 shadow-sm hover:scale-[1.03] transition-transform">
        ...
        <section className="mx-auto max-w-4xl px-6 py-24 text-center space-y-6">
          ...
          <div className="pt-4">
            <Link
              href="/signup"
              className="rounded-full bg-[#006bff] px-10 py-4 text-sm font-bold text-white hover:bg-[#0052cc] hover:scale-[1.03] active:scale-[0.98] transition-all shadow-lg shadow-[#006bff]/20 inline-flex items-center gap-1.5 animate-pulse-glow"
            >
      ...
      {/* FOOTER */}
      <footer className="border-t border-gray-100 py-20 bg-[#fafbfe]">
